...
export const PageVault: React.ComponentType = () => {
    return <>
        <Container maxWidth={'md'} fixed style={{display: 'flex'}}>
            <Nav/>
            <Box mx={2} py={1} style={{flexGrow: 1}}>
                <Box mb={2}>
                <Typography variant={'h1'} gutterBottom>Vault Configuration</Typography>
                <Typography variant={'body2'} gutterBottom>Vault config generator incorporating best-practices guidance, configuration key depdencies, and input validation.</Typography>
                </Box>
                <DemoComponent/>
            </Box>
        </Container>
